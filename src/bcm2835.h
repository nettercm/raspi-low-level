...
#define BCM2835_IRQ_BASE 				(BCM2835_PERI_BASE + 0x0000B000)
#define BCM2835_UART0_BASE				(BCM2835_PERI_BASE + 0x00201000)

extern volatile uint32_t *bcm2835_irq;
extern volatile uint32_t *bcm2835_uart0;
